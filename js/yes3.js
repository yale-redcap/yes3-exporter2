...
const YES3_RESULT_SUCCESS = "success";
...
String.prototype.toSASName = function() {
  let sanitized = this
    .toLowerCase()
    .split('')
    .filter(char => {
    ...
    .map(char => /[a-z0-9_]/.test(char) ? char : '_')
    .join('');
...
YES3.getCookie = function(cookieName) {
...
{
    message = message || YES3.captions.wait;
...
YES3.closePanel = function(panelName, retainModalState) {
