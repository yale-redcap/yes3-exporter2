...
<div class="yes3-container" id="yes3-container" style="padding-right: 20px;">
    ...
    <div class="yes3-flex-container-vbaseline yes3-fmapr-controls yes3-look-out-below">
        ...
        <div class="yes3-flex-col-33 yes3-flex-hleft yes3-ellipsis">
            <span class="yes3-title">YES3</span> <span class="yes3-subtitle">Exporter II <span class="yes3-semibold">Logs</span></span>
        </div>
    ...
    <div class="yes3-flex-container-left-aligned yes3-controls yes3-look-out-below">
        ...
        <div class="yes3-flex-left" id="yes3-fmapr-row-count"></div>

    </div>

    <!-- DATA TABLE -->

    <div class="yes3-container yes3-fmapr-export-log-table-container">
