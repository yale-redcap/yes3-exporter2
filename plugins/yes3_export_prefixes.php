...
<div id="yes3-help-panel" class="yes3-panel yes3-help-panel yes3-draggable" style="display:none">
    ...
    <div class='yes3-panel-row yes3-information'>
        ...
        <h1>REDCap field name considerations</h1>
...
<div class="yes3-container" id="yes3-container" style="padding-right: 20px;">
    ...
    <div class="yes3-flex-container-vbaseline yes3-fmapr-controls">
        ...
        <div class="yes3-flex-col-33 yes3-flex-hleft yes3-ellipsis">
            <span class="yes3-title">YES3</span> <span class="yes3-subtitle">Exporter II <span class="yes3-semibold">Event Prefixes</span></span>
        </div>
        ...
        <div class="col-lg-8 yes3-fmapr-longitudinal-only yes3-fmapr-setup-settings">
            ...
            <div class="yes3-information">
                ...
                <span style="font-size: 1.25em;"> 
                    <i class="far fa-question-circle yes3-action-icon yes3-action-icon-inline" action="Help_openPanel" title="Click for more information on event prefixes and REDCap field name considerations."></i>
                </span>
                </p>
                <p>
